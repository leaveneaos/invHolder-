...
public class InvoiceContent {
    ...
    private String item_ex_tax_amount;

    private String item_tax_amount;

    private String item_sum_amount;
    ...
    public void setRow_type(Integer row_type) {
        this.row_type = row_type;
    }

    public String getItem_sum_price() {
        return item_sum_price;
    }

    public void setItem_sum_price(String item_sum_price) {
        this.item_sum_price = item_sum_price;
    }
    ...
    public String getItem_ex_tax_amount() {
        return item_ex_tax_amount;
    }

    public void setItem_ex_tax_amount(String item_ex_tax_amount) {
        this.item_ex_tax_amount = item_ex_tax_amount;
    }

    public String getItem_tax_amount() {
        return item_tax_amount;
    }

    public void setItem_tax_amount(String item_tax_amount) {
        this.item_tax_amount = item_tax_amount;
    }

    public String getItem_sum_amount() {
        return item_sum_amount;
    }

    public void setItem_sum_amount(String item_sum_amount) {
        this.item_sum_amount = item_sum_amount;
    }
}
